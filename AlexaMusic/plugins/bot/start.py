...
async def start(client: Client, message: Message):
    ...
    await add_served_user(message.from_user.id)
    await message.reply_photo(
        photo=f"https://i.postimg.cc/QMt2kYS5/20231117-233101.png",
